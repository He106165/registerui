                    ...
                    <div v-show="radio === '1'" class="formBox">
                        <el-form ref="phoneTab" :model="phoneTab" :rules="phoneRules" label-width="80px">
                            <el-form-item label="手机号:" prop="phone">
                                <el-input v-model="phoneTab.phone" placeholder="建议使用常用手机号"/>
                            </el-form-item>
                    ...
                    <div v-show="radio === '3'" class="formBox">
                        <el-form ref="artificialFind" :model="artificialFind" :rules="artificialRule"
                            ...
                            <el-form-item label="姓名:" prop="userName">
                                <el-input v-model="artificialFind.userName" placeholder="请输入姓名"/>
                            </el-form-item>
                            <el-form-item label="证件类型:" prop="cardType">
                                <el-select v-model="artificialFind.cardType" style="width: 295px"
                            ...
                            <el-form-item label="证件号码:" prop="cardNo">
                                <el-input v-model="artificialFind.cardNo" placeholder="请输入证件号码"/>
                            </el-form-item>
                            ...
                            <!--<el-form-item label="手持证件照片:" prop="fileUrl">-->
                                <!--<el-upload-->
                                        <!--ref="cardNoRef"-->
                                        <!--v-model="artificialFind.fileUrl"-->
                            ...
                            <el-form-item label="手机号:" prop="mobile">
                                <el-input v-model="artificialFind.mobile" placeholder="建议使用常用手机号"/>
                            </el-form-item>
                            <!--<el-form-item label="验证码:" prop="checkCodePhone">-->
                            <!--<el-input v-model="artificialFind.checkCodePhone" placeholder="请输入验证码" style="width: 158px"/>-->
                            ...
                            <!--</el-form-item>-->
                            <el-form-item label="邮箱:" prop="email">
                                <el-input v-model="artificialFind.email" placeholder="请输入电子邮箱"/>
                            </el-form-item>
                            <!--<el-form-item label="验证码:" prop="checkCodeEmail">-->
                            <!--<el-input v-model="artificialFind.checkCodeEmail" placeholder="请输入验证码" style="width: 158px"/>-->
                            ...
                            <el-form-item label="密码:" prop="password">
                                <el-input v-model="artificialFind.password" type="password"
                                          placeholder="请输入密码,必须包含字母、数字，长度在8-16位"/>
                            </el-form-item>
                            <el-form-item label="确认密码:" prop="checkPass" style="font-size:13px">
                                <el-input v-model="artificialFind.checkPass" type="password" placeholder="请输入确认密码"/>
                            </el-form-item>
                        </el-form>
                        <div class="nextStep">
                        ...
                        <el-form ref="newPassword" :model="newPassword" :rules="passwordRules"
                            ...
                            <el-form-item prop="newPassword">
                                <el-input v-model="newPassword.newPassword" type="password" placeholder=" 请再次输入密码"
                                          style="padding-top: 40px"></el-input>
                            </el-form-item>
                        </el-form>
                        <div class="nextStep">
