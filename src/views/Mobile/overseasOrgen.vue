...
<div id="overseaOrgen">
  ...
  >
    <el-form-item
      label="Institution English Name/机构英文名称"
      prop="englishName"
    >
      <el-input
        v-model="overseaOrgen.englishName"
        placeholder=" Please select institution English Name"
        label-width="300px"
      />
    </el-form-item>
    <el-form-item label="Country/Region所属国家/地区：" prop="country">
      <el-select
        v-model="overseaOrgen.country"
        clearable
        filterable
        style="width: 100%"
        placeholder="请选择"
    ...
    <el-form-item label="Contact Name/联系人姓名：" prop="hostpersionName">
      <el-input
        v-model="overseaOrgen.hostpersionName"
    ...
    <el-form-item label="Contact Email/联系人邮箱：" prop="hostpersionEmail">
      <el-input
        v-model="overseaOrgen.hostpersionEmail"
    ...
    <el-form-item label="Contact Details/联系电话" prop="hostpersionTelephone">
      <el-input
        v-model="overseaOrgen.hostpersionTelephone"
        placeholder="legalIdnumber"
        label-width="80px"
      />
    </el-form-item>
    <el-form-item label="Password/密码：" prop="password">
      <el-input
        v-model="overseaOrgen.password"
        type="password"
    ...
    <el-form-item label="Confirm Password/确认密码：" prop="checkPassword">
      <el-input
        v-model="overseaOrgen.checkPassword"
        type="password"
...
export default {
    ...
    return {
      ...
      overseasRules: {
        englishName: [
          {
            required: true,
            message: "Please select institution English Name",
            trigger: "blur"
          }
        ],
        country: [
        ...
        address: [
          {
            required: true,
            message: "Please select  englishName",
            trigger: "blur"
          }
        ],
        hostpersionName: [
          ...
          },
          {
            min: 0,
            max: 2000,
            message: "Contact names should not exceed 2000 characters！",
            trigger: "blur"
          },
          {
            pattern: /^[^`~!@#$^&()\+=<>?:"{}|\'\[\]·~！@#￥……&（）\+={}|《》？：“”【】‘’。]+$/,
        ...
        hostpersionTelephone: [
          ...
          {
            max: 11,
            message: "Please fill in the 11-digit cell phone number",
            trigger: "blur"
          },
          {
        ...
        password: [
          ...
          },
          {
            ...
            message:
              "Passwords must contain letters and Numbers between 8 and 16 bits long"
          }
        ],
        checkPassword: [
  ...
  methods: {
    // 光标移出时
    focusEmailOrg(overseaOrgen, checkCode) {
      //form名、当前值的名
