...
<div id="overseaSchFed">
  ...
  >
    <el-form-item label="机构中文名称：" prop="enterpriseName">
      <el-input
        v-model="overseaSchFed.enterpriseName"
        placeholder="请输入中文名称"
        label-width="80px"
      />
    </el-form-item>
    <el-form-item label="机构英文名称：" prop="englishName">
      <el-input
        v-model="overseaSchFed.englishName"
        placeholder="请输入英文名称"
        label-width="80px"
      />
    </el-form-item>
    ...
    <el-form-item label="使领馆教育处：" prop="consulateName">
      <el-select
        v-model="overseaSchFed.consulateName"
        clearable
        filterable
        style="width: 100%"
        placeholder="请选择"
      ...
      >
        <el-option
          v-for="item in consulateInfoList"
          :key="item.values"
          :label="item.label"
          :value="item.values"
        />
    ...
    <el-form-item label="联系人姓名：" prop="hostpersionName">
      <el-input
        v-model="overseaSchFed.hostpersionName"
    ...
    <el-form-item label="联系人邮箱：" prop="hostpersionEmail">
      <el-input
        v-model="overseaSchFed.hostpersionEmail"
    ...
    <el-form-item label="联系电话" prop="hostpersionTelephone">
      <el-input
        v-model="overseaSchFed.hostpersionTelephone"
        placeholder="请输入联系方式"
        label-width="80px"
      />
    </el-form-item>
    <el-form-item label="密码：" prop="password" style="margin-bottom: 32px">
      <el-input
        v-model="overseaSchFed.password"
        type="password"
        placeholder="请输入密码"
        label-width="80px"
      />
    ...
    <el-form-item label="确认密码：" prop="checkPassword">
      <el-input
        v-model="overseaSchFed.checkPassword"
        type="password"
        placeholder="请再次输入密码"
        label-width="80px"
      />
...
export default {
    ...
    return {
      ...
      overseasRules: {
        ...
        password: [
          // {
          //   required: true,
          //   message: "请输入密码(8-16位字符，必须由数字、字母组成)",
          //   trigger: "blur"
          // },
          // {
  ...
  methods: {
    // 光标移出时
    focusEmailOrg3(overseaSchFed, checkCode) {
      //form名、当前值的名
